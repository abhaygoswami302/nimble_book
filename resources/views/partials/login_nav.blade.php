    ...
    <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
      ...
      <li class="flex items-center">
        <a
          ...
          href="#pablo"
          ><i
            class=" animate-pulse lg:text-gray-300 text-gray-500 fas fa-bookmark text-lg leading-lg "
          ></i
      ...
      <li class="flex items-center">
        <a
          ...
          <span class="animate-ping absolute inline-flex h-5 w-7 rounded-2 bg-purple-400 opacity-75"></span>
